...
namespace FluentCommands
{
    ...
    {
        public bool UseInternalKeyboardStateHandler { get; private set; }
        public bool UseDefaultErrorMessage { get; private set; } = true;
        public MenuItem DefaultErrorMessage { get; private set; } = MenuItem.As().Text().TextSource("ERROR OCCURRED.").Done();
        public string Prefix { get; private set; } = "/";
        public RegexOptions CommandNameRegexOptions { get; private set; } = RegexOptions.None;
        public bool DeleteCommandAfterCall { get; private set; }
