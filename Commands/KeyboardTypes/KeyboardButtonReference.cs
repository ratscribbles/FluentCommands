...
namespace FluentCommands.Commands.KeyboardTypes
{
    public class KeyboardButtonReference : IFluentInterface
    {
        ...
        /// <summary>
        /// Creates a reference to an <see cref="ICommand"/> object's <see cref="InlineKeyboardButton"/> reference (or the actual command if no button is set for it, and <see cref="CommandServiceConfig.BruteForceKeyboardReferences"/> is set to true), with a link to its containing command module.
        /// </summary>
