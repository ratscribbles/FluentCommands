...
namespace FluentCommands.Commands.Steps
{
    ...
    /// </summary>
    /// <remarks>Decorator class that removes the ambiguity of the return type for end-users, but simulates a fluent interface's design of hiding certain methods from showing up with intellisense.
