...
{
    public interface IMenuAnimationOptionalBuilder : IReplyMarkupable<IMenuAnimationReplyMarkup>, IFluentInterface, ISendableMenu
    {
        /// <summary>
        /// Optional. The <see cref="System.Threading.CancellationToken"/> for this <see cref="Menu"/>.
        /// <para>Provides the Token responsible for notifying when the <see cref="Menu"/> should cancel its send operation.</para>
        /// </summary>
        /// <param name="token"></param>
        /// <returns></returns>
        IMenuAnimationCancellationToken CancellationToken(CancellationToken token);
        /// <summary>
        /// Optional. Animation caption (may also be used when resending animation by file_id), 0-1024 characters.
        /// </summary>
        /// <param name="caption"></param>
        /// <returns>Returns this <see cref="Menus.Menu"/> to continue fluently building its parameters.</returns>
        IMenuAnimationCaption Caption(string caption);
        /// <summary>
