...
{
    public interface IMenuInvoiceOptionalBuilder : IReplyMarkupableForceInline<IMenuInvoiceReplyMarkup>, IFluentInterface, ISendableMenu
    {
        /// <summary>
        ...
        IMenuInvoiceCancellationToken CancellationToken(CancellationToken token);
        /// <summary>
