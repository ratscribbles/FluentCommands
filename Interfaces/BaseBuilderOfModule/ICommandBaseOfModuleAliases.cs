...
{
    /// <summary>
    /// Fluent builder of <see cref="CommandModuleBuilder{TModule}"/> with <see cref="HasDescription(string)"/> as the first immediate option.
    /// </summary>
    ...
    public interface ICommandBaseOfModuleAliases<TModule> : IFluentInterface where TModule : class
    {
        /// <summary>
