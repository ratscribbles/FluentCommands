...
{
    /// <summary>
    /// Fluent builder of <see cref="ModuleBuilder"/> with <see cref="HasDescription(string)"/> as the first immediate option.
    /// </summary>
    public interface ICommandBaseOfModuleAliases : IFluentInterface
    {
        ...
        ICommandBaseOfModuleDescriptionBuilder HasDescription(string description);
        /// <summary>
