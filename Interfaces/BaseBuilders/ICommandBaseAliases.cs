...
{
    /// <summary>
    /// Fluent builder selection of <see cref="ICommandBaseBuilder{TModule}"/>, with <see cref="HasHelpDescription(string)"/> being the first available option in Intellisense.
    /// </summary>
    ...
    public interface ICommandBaseAliases<TModule> : IFluentInterface where TModule : class
    {
        /// <summary>
