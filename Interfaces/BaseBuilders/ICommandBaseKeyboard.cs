...
{
    /// <summary>
    /// Fluent builder selection of <see cref="ICommandBaseBuilder"/>, with <see cref="KeyboardButtonReference(IKeyboardButton)"/> being the only available option in Intellisense.
