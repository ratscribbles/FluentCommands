...
{
    /// <summary>
    /// Fluent builder selection of <see cref="ICommandBaseBuilder"/>, with <see cref="WithParseMode(ParseMode)"/> being the only option available in Intellisense.
    ...
    public interface ICommandDescriptionBuilder : IFluentInterface
    {
        ...
        ICommandBaseDescription WithParseMode(ParseMode parseMode);
    }
}
