...
{
    /// <summary>
    /// Fluent interface for creating an  <see cref="IInlineKeyboardBuilder"/> only, due to this <see cref="Menus.Menu"/> or <see cref="Command"/> only accepting an <see cref="InlineKeyboardMarkup"/>.
    /// </summary>
