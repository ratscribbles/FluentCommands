...
namespace FluentCommands.Interfaces.KeyboardBuilders
{
    public interface IReplyMarkupable<TBuilder> where TBuilder : class, IFluentInterface
    {
        ...
        /// <summary>
        /// Adds a <see cref="ReplyKeyboardMarkup"/> to the <see cref="Command"/> or <see cref="Menus.Menu"/>.
        /// </summary>
        /// <param name="markup">The <see cref="ReplyKeyboardMarkup"/> for this future <see cref="Command"/> or <see cref="Menus.Menu"/>.</param>
        /// <returns>Returns this <see cref="TBuilder"/>, removing this option from the fluent builder.</returns>
        TBuilder ReplyMarkup(ReplyKeyboardMarkup markup);
        /// <summary>
        /// Adds a <see cref="ForceReplyMarkup"/> to the <see cref="Command"/> or <see cref="Menus.Menu"/>.
        /// </summary>
        /// <param name="markup">The <see cref="ForceReplyMarkup"/> for this future <see cref="Command"/> or <see cref="Menus.Menu"/>.</param>
        /// <param name="selectve"></param>
        /// <returns>Returns this <see cref="TBuilder"/>, removing this option from the fluent builder.</returns>
        TBuilder ReplyMarkup(ForceReplyMarkup markup, bool selective = false);
        /// <summary>
        /// Adds a <see cref="ReplyKeyboardRemove"/> to the <see cref="Command"/> or <see cref="Menus.Menu"/>.
        /// </summary>
        /// <param name="markup">The <see cref="ReplyKeyboardRemove"/> for this future <see cref="Command"/> or <see cref="Menus.Menu"/>.</param>
        /// <param name="selectve"></param>
        /// <returns>Returns this <see cref="TBuilder"/>, removing this option from the fluent builder.</returns>
