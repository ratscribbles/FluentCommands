...
namespace FluentCommands.Interfaces.MenuBuilders.AudioBuilder
{
    public interface IMenuAudioOptionalBuilder : IReplyMarkupable<IMenuAudioReplyMarkup>, IFluentInterface, IMenuItem
    {
        ...
        /// <para>Provides the Token responsible for notifying when the <see cref="Menus.MenuItem"/> should cancel its send operation.</para>
        /// </summary>
        /// <param name="token"></param>
        /// <returns>Returns this <see cref="Menus.MenuItem"/> to continue fluently building its parameters.</returns>
        IMenuAudioCancellationToken CancellationToken(CancellationToken token);
        /// <summary>
        /// Optional. Audio caption, 0-1024 characters.
        /// </summary>
        /// <param name="caption"></param>
        /// <returns>Returns this <see cref="Menus.MenuItem"/> to continue fluently building its parameters.</returns>
        IMenuAudioCaption Caption(string caption);
        /// <summary>
        /// Optional. Sends the message silently. Users will receive a notification with no sound.
        /// </summary>
        /// <param name="disableNotification"></param>
        /// <returns>Returns this <see cref="Menus.MenuItem"/> to continue fluently building its parameters.</returns>
        IMenuAudioDisableNotification DisableNotification(bool disableNotification);
        /// <summary>
